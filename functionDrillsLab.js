...
function add (arg1, arg2){
 arg1change=parseInt(arg1)
 arg2change=parseInt(arg2)
 return arg1change + arg2change
}
let sum = add('4 feet','5geet ')
console.log(sum)
////////////////// PROBLEM 7 ////////////////////
...
bestMovie('Sharknado')
let bestMovieofAllTime = bestMovie('Sharknado')
console.log(bestMovieofAllTime)
...
let emailstring2 = emailstring.trim()
if(emailstring2.includes('@') === true)
return 'email verified'
else {
  return 'must provide a valid email address'
}
}
let verifyEmail = emailCheck('amyegarry@gmail.com   ')
...
//CODE HERE
function ChocolateFrogMaxizer (gold)  {
while (gold>= 3){
  return gold/3
}
}
let totalFrogs = ChocolateFrogMaxizer(4)
...
//CODE HERE
function ChocolateFrogMaxizer2 (gold)  {
 if (gold %3 ===0 ){
    return gold/3}
    else if ((gold-1) % 3 === 0 ){
    return (gold -1)/3}
  ...
  let totalFrogs2 = ChocolateFrogMaxizer2(4)
